/**
 * Creet - Agent Tracker Module
 * Tracks Task (sub-agent) lifecycle for real-time dashboard updates.
 *
 * State file: .creet/agent-dashboard.json (relative to project root)
 ...
 * Priority: CWD/.creet/ (project-local)
 */
...
/**
 * Ensure the .creet/ directory exists.
 */
